...
def main():
    ...
    processor = GPTProcessor(openai_api_key, anthropic_api_key)

    pdf_path = "/Users/twang/Downloads/RNN-2.pdf"
    output_folder = "/Users/twang/PycharmProjects/transition_test/output-final"
    ...
    # Step 3: Create video from Claude's output
    video_path, descriptions, durations = processor.create_video_from_context(final_context_file, image_files, output_folder)
